        ...
        if ($existeUsuario) {
            ...
            if (!empty($nombre) && !empty($email) && !empty($contrasena)  && !empty($rol)) {
                ...
                if (strlen($contrasena) < 6) {
                    ...
                    $sqlInsert = "INSERT INTO `usuarios` (nombre, email, contrasena, rol,dni, telefono, apellido, createdAt)
                                  VALUES (:nombre, :email, :contrasena, :rol, :dni, :telefono, :apellido, :createdAt)";
