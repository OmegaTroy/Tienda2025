...
export default function Detail() {
  ...
  useEffect(() => {
    const product = productos.find(
      (e) => e.idProducto === parseInt(idProducto)
    );
    setProducto(product);
  ...
  const handleWhatsappMessage = () => {
    ...
    const formattedPrice = Number(producto?.precio)
      .toFixed(2)
      .replace(/\B(?=(\d{3})+(?!\d))/g, ".");
        ...
        <div className="deFLexIcon">
          ...
          >
            <FontAwesomeIcon
              icon={faHeart}
              style={{
                color: favoritos.includes(producto.idProducto) ? "red" : "gray",
              }}
            />
          </button>
          <button className="share" onClick={handleCompartirClick}>
            {" "}
      ...
      <div className="detail-contain">
        ...
        <div className="textDetail">
          ...
          <div className="deFLexPrice">
            ...
            {producto?.precioAnterior !== 0 &&
              producto?.precioAnterior !== undefined && (
                <h5 className="precioTachadoDetail">
                  $
                  {`${producto?.precioAnterior}`.replace(
                    /\B(?=(\d{3})+(?!\d))/g,
                    "."
                  )}
                </h5>
          ...
          <div className="deFlexGoTocart">
            <button
              onClick={() => addToCart(items[selectedItemIndex])}
              className="btnAdd"
            >
            ...
            <>
              ...
              >
                ...
                <div className="modal-send-form">
                  ...
                  />
                  <button onClick={handleWhatsappMessageCart} className="btn">
                    Enviar
                  </button>
                </div>
              </ModalCart>
